...
// <p>Custom widget loaded.</p>
template.innerHTML = `<div id="svg-container" style="width: 100%; height: 100%"></div>`
...
class Candlestick extends HTMLElement {
    constructor() {
        ...
        const container = this._shadowRoot.querySelector("#svg-container");

        this.renderCandlesticksHighcharts(container);
    }
    ...
    renderCandlesticksHighcharts(container) {
        const options = {
            title: {
...
customElements.define("com-candlestick-chart", Candlestick);
...
class CandlestickBuilderPanel extends HTMLElement {
    constructor() {
        super();
        this._shadowRoot = this.attachShadow({mode: "open"});
...
let stylingTemplate = document.createElement("template");
...
class CandlestickStylingPanel extends HTMLElement {
    constructor() {
        super();
        this._shadowRoot = this.attachShadow({mode: "open"});
